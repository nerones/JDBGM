...
public class DB2CreateTableQuery extends DefaultCreateTableQuery implements CreateTableQuery {


    public DB2CreateTableQuery() {
        super();
    }
    ...
    public String toString() {
		...
		for(int j =0; j < columns.size(); j++){
			...
			query1 += DB2DataTypes.getAsString(df);
