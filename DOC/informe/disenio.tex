...
\end{itemize}
%
El comportamiento de cada una de estas clases puede ser implementado directamente desde las restricciones impuestas en la sección \fullref{seccion:especificacion:dialectos} pero siguiendo ciertos lineamientos que  se verán a continuación.
...
%
%un análisis más detallado de como se componen las interfaces finales y las clases que las implementan además de una vista a su implementación y las clases que sirven como componente de las principales.
