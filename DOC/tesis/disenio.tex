...
Lo primero que se busca es encontrar las diferencias en la base de las consultas, como son los tipos de datos. Entre los tres \dd encontramos que si bien los tipos de datos deben ser básicamente los mismos, hay diferencias con tipos de datos especializados, así que veamos una tabla comparativa:

\begin{center}
\begin{tabular}{|c|c|c|}
\hline \s & \m & \p \\ 
\hline Integer & INT, LONGINT & • \\ 
\hline  &  &  \\ 
\hline  &  &  \\ 
\hline  &  &  \\ 
\hline  &  &  \\ 
